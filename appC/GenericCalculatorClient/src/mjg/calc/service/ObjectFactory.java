 ...
 * generated in the mjg.calc.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://service.calc.mjg/", "subtract");
    private final static QName _AddResponse_QNAME = new QName("http://service.calc.mjg/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://service.calc.mjg/", "multiplyResponse");
    private final static QName _Divide_QNAME = new QName("http://service.calc.mjg/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://service.calc.mjg/", "multiply");
    private final static QName _Add_QNAME = new QName("http://service.calc.mjg/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://service.calc.mjg/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://service.calc.mjg/", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mjg.calc.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.calc.mjg/", name = "subtractResponse")
